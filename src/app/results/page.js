      ...
      <Grid container direction="column" spacing={2} justifyContent="center">
        {standings.map((team, index) => (
          <Grid item xs={12} key={index}>
            <TableItem style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "15px 20px" }}>
              <Typography variant="body1" style={{ flex: 0.5, fontSize: "16px", textAlign: "center" }}>
                {team.position}
              </Typography>
              <Typography variant="body1" style={{ flex: 1.5, fontSize: "16px", textAlign: "center" }}>
                {team.team}
              </Typography>
              <Typography variant="body1" style={{ flex: 1, fontSize: "16px", textAlign: "center" }}>
                {team.pd}
              </Typography>
              <Typography variant="body1" style={{ flex: 1, fontSize: "16px", textAlign: "center" }}>
                {team.gd}
